...
const AdminSidebar: FC<AdminSidebarProps> = ({ activeView, onNavigate, onSignOut }) => {
    ...
    <div className="w-52 bg-primary flex flex-col h-full shrink-0">
      ...
      <div className="px-5 py-5 border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <img src="/src/img/up.png" alt="UP" className="h-8 w-8 object-contain rounded-lg" onError={(e) => (e.currentTarget.style.display = 'none')} />
          <div>
            <p className="text-white font-bold text-sm leading-tight">UPOU Helpdesk</p>
      ...
      <div className="px-3 py-4 border-t border-white/10">
        <div className="flex items-center gap-2.5 px-2 mb-3">
          ...
          <div>
            <p className="text-white text-xs font-semibold leading-tight">Dr. Ramona Aquino</p>
