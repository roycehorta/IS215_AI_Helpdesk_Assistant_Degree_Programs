...
import { CheckCircle2, Clock, InboxIcon } from "lucide-react";
...
const DashboardOverview: FC<Props> = ({ tickets, onNavigate }) => {
  ...
  const completed = tickets.filter((t) => t.status === "Answered").length;
  ...
  const statCards = [
    ...
    },
    {
      label: "New",
      value: newTickets,
      sub: `${total ? Math.round((newTickets / total) * 100) : 0}% pending`,
      icon: Clock,
      color: "text-blue-500",
    },
    {
      ...
      sub: `${total ? Math.round((answeredTickets / total) * 100) : 0}% done`,
      icon: CheckCircle2,
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-white rounded-xl border border-gray-200 p-5">
            ...
            <p className="text-xs text-gray-400 mb-4">
              Current breakdown of all tickets
            </p>
