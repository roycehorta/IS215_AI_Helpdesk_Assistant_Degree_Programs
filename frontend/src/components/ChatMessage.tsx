...
const ChatMessage: FC<ChatMessageProps> = ({
  ...
  // Create a unique cache key for this message. If timestamp is missing, fallback to index (less ideal but prevents bugs).
  ...
  return (
    <div
      className={`flex gap-3 ${message.sender === "user" ? "flex-row-reverse" : "flex-row"} mb-6`}
    >
      {/* Avatar */}
      {message.sender === "bot" ? (
      ...
      {/* Bubble — keep everything inside exactly as it was */}
      <div
